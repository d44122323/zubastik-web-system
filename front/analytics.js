...
function renderCalculator(data) {
    document.getElementById("calcOpen").textContent =
        data.open || 0;
    document.getElementById("calcFinish").textContent =
        data.finish || 0;
    document.getElementById("calcRequest").textContent =
        data.request || 0;
}
...
const total =
document.getElementById("aiTotal");
...
const box =
document.getElementById("aiQuestions");
